            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 animate-fade-in-down">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-3 animate-scale-in delay-200">
                            <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg animate-pulse-glow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-cyan-500 hover:shadow-xl transition-all duration-300 card-3d stagger-item">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-600 uppercase tracking-wide">Total Properties</p>
                                <p className="text-4xl font-bold text-gray-900 mt-3 animate-count-up">{loading ? '...' : properties.length}</p>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-pink-500 hover:shadow-xl transition-all duration-300 card-3d stagger-item delay-200">
                        <div className="flex items-center justify-between">
                            <div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="px-4 py-2 text-sm font-medium text-white bg-[#3ed83e] rounded-lg hover:bg-green-700 transition-all duration-200 flex items-center gap-2 btn-ripple hover:scale-105 animate-pulse-glow"
                            >
                                ➕ Add Property
                            </button>
                            <button
                                onClick={() => navigate('/properties')}
                                className="px-4 py-2 text-sm font-medium text-white bg-[#665fe0] rounded-lg hover:bg-indigo-700 transition-all duration-200 btn-ripple hover:scale-105"
                            >
                                🏘️ Browse Properties
                            </button>
                            <button
                                onClick={() => setRefreshTrigger(prev => prev + 1)}
                                className="px-4 py-2 text-sm font-medium text-cyan-600 bg-cyan-50 rounded-lg hover:bg-cyan-100 transition-all duration-200 hover:scale-105"
                            >
                                Refresh
                            </button>
                        </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16 animate-fade-in-up">
                            <div className="mx-auto w-20 h-20 bg-gradient-to-br from-cyan-100 to-purple-100 rounded-full flex items-center justify-center mb-4 animate-pulse-slow">
