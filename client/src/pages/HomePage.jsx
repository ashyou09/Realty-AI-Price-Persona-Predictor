...
function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Hero Section */}
            <div className="relative wave-bg overflow-hidden py-20 lg:py-32">
                {/* Animated Wave Layers with Color Changes */}
                <div className="wave-layer wave-layer-1">
                    <div className="absolute inset-0 gradient-animate bg-gradient-to-br from-cyan-300 via-blue-400 to-purple-400"></div>
                </div>
                <div className="wave-layer wave-layer-2">
                    <div className="absolute inset-0 gradient-animate bg-gradient-to-tr from-blue-300 via-purple-400 to-pink-400" style={{ animationDelay: '2s' }}></div>
                </div>
                <div className="wave-layer wave-layer-3">
                    <div className="absolute inset-0 gradient-animate bg-gradient-to-bl from-purple-300 via-pink-400 to-cyan-400" style={{ animationDelay: '4s' }}></div>
                </div>
                {/* Static Background */}
                        ...
                        <div className="animate-fade-in-up">
                            ...
                            {!isAuthenticated ? (
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <Link
                                        to="/register"
                                        className="btn-premium inline-flex items-center justify-center shadow-glow-indigo"
                                    >
                                        Get Started
                                    ...
                                    <Link
                                        to="/login"
                                        className="inline-flex items-center justify-center px-8 py-4 bg-white text-indigo-600 font-semibold rounded-lg border-2 border-indigo-600 hover:bg-indigo-50 transition-all duration-300 hover:scale-105"
                                    >
                                        Sign In
                                    </Link>
                                </div>
                                ...
                                <Link
                                    to="/properties"
                                    className="inline-flex items-center justify-center px-8 py-4 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 ripple-container"
                                >
                                    See Properties
                                    <svg className="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
            ...
            {/* Statistics Section */}
            <div className="relative py-24 bg-gradient-to-b from-white via-indigo-50/30 to-purple-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {/* Total Properties Analyzed */}
                        <div className="stagger-item card-premium p-6 shadow-premium hover:shadow-premium-lg">
                            <div className="flex items-center gap-4">
                                <div className="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                        ...
                        <div className="stagger-item card-premium p-6 shadow-premium hover:shadow-premium-lg">
                            <div className="flex items-center gap-4">
                                <div className="w-16 h-16 bg-purple-100 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                        ...
                        {/* Satisfied Users */}
                        <div className="stagger-item bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover-lift">
                            <div className="flex items-center gap-4">
                                <div className="w-16 h-16 bg-orange-100 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                        ...
                        <div className="stagger-item bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover-lift">
                            <div className="flex items-center gap-4">
                                <div className="w-16 h-16 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
            ...
            <div id="why-choose" className="relative py-20 bg-gradient-to-b from-purple-50/30 to-indigo-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* AI-Powered Insights */}
                        <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 group">
                            <div className="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center mb-6 transition-all duration-300 group-hover:bg-blue-200 group-hover:rotate-6">
            ...
            {/* CTA Section */}
            <div className="relative bg-gradient-to-b from-[#e3e3ff] via-[#a58bff] to-[#4f28dd] py-16 lg:py-32">
